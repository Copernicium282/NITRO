...
recipes.addShapeless("goldcell", <ironjetpacks:gold_cell>, [<nuclearcraft:lithium_ion_cell>]);
recipes.addShapeless("steelcell", <ironjetpacks:steel_cell>, [<nuclearcraft:lithium_ion_cell>]);
